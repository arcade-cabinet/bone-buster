...
// CR-H1eng / H-3 — enemy projectile sim (EnemyBullet, makeEnemyBullet,
// stepEnemyBullet, ENEMY_BULLET_*) lives in `src/engine/projectiles.ts` so
// the yuka dependency sits where depending on @ai is in-direction. engine.ts
// no longer imports @ai. Consumers import from `@engine/projectiles`.
